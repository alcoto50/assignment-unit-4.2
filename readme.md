...
- Add a new `div` with a class name of "info". 
  ...
  - Add an image tag `<img>` and source an image of your main mode of transportation (you car, bus, scooter, bike, feet, etc).  Hint: This will be easier if you copy the picture into the assignment folder first!
